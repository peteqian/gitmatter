...
The default image is `ghcr.io/git-matter/gitmatter:latest`. For production, pin a release tag with
`GITMATTER_IMAGE`, for example `ghcr.io/git-matter/gitmatter:v2026.06.22`.
