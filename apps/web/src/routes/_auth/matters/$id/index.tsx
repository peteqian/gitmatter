...
function MatterWorkspace() {
  ...
  return (
    <PageShell
      ...
      header={
        /* Inline "Matters › Name" trail + two action groups: a frosted icon pill
           (search / people / …) and New Chat / New Review. */
        <PageHeader
...
function DocumentsTab({ matterId, canEdit }: { matterId: string; canEdit: boolean }) {
  ...
  // (like MatterFileExplorer's tree), not a native window.prompt.
