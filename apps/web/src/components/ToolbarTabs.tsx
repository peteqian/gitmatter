...
// Thin tab bar: underlined active tab on the left, optional actions on the right.
// Lighter and denser than the shadcn Tabs primitive — used for the matter
// workspace and list pages.
