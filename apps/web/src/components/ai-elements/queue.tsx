...
export const QueueSectionTrigger = ({
  ...
  <CollapsibleTrigger
    render={
      <button
        className={cn(
          "group flex w-full items-center justify-between rounded-md bg-muted/40 px-3 py-2 text-start text-sm font-medium text-muted-foreground transition-colors hover:bg-muted",
          className
        )}
        type="button"
        {...props}
