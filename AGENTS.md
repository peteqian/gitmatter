...
Organized as **Client → Matter → artifacts**, with a legal team staffed per matter and every change traceable to a member. Heavily inspired by **[mikeoss](https://mikeoss.com)** — see `README.md` for credits.
